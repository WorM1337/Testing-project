...
public class ProductMappingProfile : Profile
{
    public ProductMappingProfile()
    {
        ...
        CreateMap<CreateProductDto, Product>()
            ...
            .ForMember(dest => dest.CookingRequirement, opt => opt.MapFrom(src => src.CookingNeeded));
        ...
        CreateMap<Product, ProductDto>()
            ...
            .ForMember(dest => dest.CookingNeeded, opt => opt.MapFrom(src => src.CookingRequirement));
    }
}
