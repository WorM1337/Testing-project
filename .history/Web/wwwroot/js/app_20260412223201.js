  ...
  async handleFormSubmit(event) {
    ...
    config.fields.forEach((field) => {
      ...
      if (input) {
        ...
        // For select elements (category, cookingRequirement), always include the value if changed
        if (
          ...
          // Skip if empty value
          if (val === "") {
            // For PATCH, just skip unchanged empty values
            if (isPatch) {
              return;
            }
            // For CREATE, show error
          ...
          if (isPatch && this.originalFormData) {
